                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-end">
                            <h3 class="card-title col align-self-center">Form Edit Data Kuisioner</h3>
                        </div>
                        <form id="editDataForm">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_formulir" name="nama_formulir" placeholder="Nama Kuisioner" value="{{ $data->nama_formulir }}">
                                </div>
                            </div>
    ...
    <script>
        function editData(id){
            ...
            if (result.isConfirmed) {
                    $.ajax({
                    url: "{{ url('admin/survey-form/edit') }}/" + id,
                    type: 'PUT',
                    headers: {
