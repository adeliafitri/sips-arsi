        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header d-flex justify-content-end">
              <h3 class="card-title col align-self-center">Form Tambah Data Jenis CPL</h3>
              <!-- <div class="col-sm-2">
                  <a href="index.php?include=data-mahasiswa" class="btn btn-warning"><i class="nav-icon fas fa-arrow-left mr-2"></i> Kembali</a>
              </div> -->
            </div>
              <div class="card-body">
              <form action="{{ route('admin.jeniscpl.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <!-- <div class="form-group">
                  ...
                  <textarea class="form-control text-muted" id="deskripsi" name="deskripsi" rows="3">Deskripsi</textarea>
                </div> -->
              </div>
               <!-- /.card-body -->
