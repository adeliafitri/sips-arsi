            ...
            <div class="card-header d-flex justify-content-end">
              ...
              <form action="{{ route('admin.mahasiswa.store') }}" method="post" enctype="multipart/form-data">
                @CSRF
                  ...
                  <div class="form-group col-8">
                    <label for="tanggal_lahir">Tanggal Lahir</label>
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" id="tanggal_lahir" name="tanggal_lahir" placeholder="Tanggal Lahir" data-target="#reservationdate"/>
                  ...
                  <input type="email" class="form-control" id="email" rows="3" name="email" placeholder="Email">
                  </div>
                  </div>
               <!-- /.card-body -->
