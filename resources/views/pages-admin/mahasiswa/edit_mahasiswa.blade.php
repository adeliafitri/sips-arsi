          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header d-flex justify-content-end">
                ...
                <div class="card-body">
                <form action="{{ route('admin.mahasiswa.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                    <label for="nim">NIM</label>
                    <input type="text" class="form-control" id="nim" name="nim" placeholder="NIM" value="{{ $data->nim }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group col-8">
                      <label for="tanggal_lahir">Tanggal Lahir</label>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            ...
                            @endphp
                            <input type="text" class="form-control datetimepicker-input" id="tanggal_lahir" name="tanggal_lahir" placeholder="Tanggal Lahir" data-target="#reservationdate" value="{{ $formattedDate}}"/>
                    ...
                    <div class="form-group col">
                      ...
                      <input type="radio" name="jenis_kelamin" value="L" @if($data->jenis_kelamin=="L")
                        checked @endif> Laki-laki
                      <input type="radio" name="jenis_kelamin" value="P" @if($data->jenis_kelamin=="P")
                    ...
                    <input type="email" class="form-control" id="email" rows="3" name="email" placeholder="Email" value="{{ $data->email }}" disabled>
                    </div>
                    <div class="form-group">
