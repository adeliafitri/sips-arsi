          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex col-sm-12 justify-content-between">
                <div class="col-10">
                  <form action="{{ route('admin.cpmk') }}" method="GET">
                ...
                <div class="col-sm-2">
                    <a href="{{ route('admin.cpmk.create') }}" class="btn btn-primary"><i class="nav-icon fas fa-plus mr-2"></i> Tambah Data</a>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.cpmk.edit', $datas->id) }}" class="btn btn-secondary mt-1"><i class="nav-icon fas fa-edit mr-2"></i>Edit</a>
                            <form action="{{ route('admin.cpmk.destroy', $datas->id) }}" method="post" class="mt-1">
                                @csrf
                                @method('delete')
