                            ...
                            <div class="">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('admin.rps.download-excel', $rps->id) }}"><i class="fas fa-download mr-2"></i> Export Excel</a>
...
<script>
    ...
    function addCpmk(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/rps/create/cpmk') }}/" + id,
            data: form.serialize(),
    ...
    function addSubCpmk(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/rps/create/subcpmk') }}/" + id,
            data: form.serialize(),
            success: function(response) {
                if (response.status == "success") {
                    Swal.fire({
    ...
    function addSoal(id) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/rps/create/soal') }}/" + id,
            data: form.serialize(),
            success: function(response) {
                if (response.status == "success") {
                    Swal.fire({
        ...
        function addFile() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/rps/create/import-excel') }}/" + {{ $rps->id }},
                // data: form.serialize(),
                data: formData,
                processData: false,
                contentType: false,
