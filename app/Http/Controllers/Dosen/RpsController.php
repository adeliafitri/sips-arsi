...
class RpsController extends Controller
{
    ...
    //     // return $data_matkul;
    //     return view('pages-dosen.mata_kuliah.tambah_rps')->with('data', $data_cpmk);
    // }
    ...
    public function create($id)
    {
        ...
        // dd($data_cpmk);
        return view('pages-dosen.mata_kuliah.tambah_rps', compact('cpl', 'matkul', 'kode_cpmk', 'kode_subcpmk', 'data_cpmk', 'start_number'));
    }
    ...
    public function storecpmk(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('dosen.rps.create', $id)->with('success', 'Data Berhasil Ditambahkan');
        } catch (\Exception $e) {
    ...
    public function storesubcpmk(Request $request, $id)
    {
        ...
        try {
            ...
            // return response()->json(['success' => true, 'message' => 'Data berhasil ditambahkan']);
            return redirect()->route('dosen.rps.create', $id)->with('success', 'Data Berhasil Ditambahkan');
            // return redirect()->route('dosen.rps.storecpmk')->with('success', 'Data Berhasil Ditambahkan');
        } catch (\Exception $e) {
            return redirect()->back()->withErrors(['errors' => 'Data Gagal Ditambahkan: ' . $e->getMessage()])->withInput();
        }
    }
